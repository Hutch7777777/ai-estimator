...
export const DEFAULT_WINDOW_TRIM: WindowTrimSettings = {
  include: true,
  material: 'hardie_5/4x4',
  include_slope_sill: false,
  manual_lf: null,
};
...
export const DEFAULT_WRB: WRBSettings = {
  product: 'tyvek-homewrap',
  layer_mode: 'auto',
  include_seam_tape: true,
};

export const DEFAULT_FLASHING: FlashingSettings = {
  window_head: 'z-flashing',
  door_head: 'z-flashing',
  base_starter: 'z-flashing',
  include_kickout: true,
  include_corner_flashing: true,
  include_fortiflash: true,
  include_moistop: true,
  include_rolled_galv: false,
  include_joint_flashing: true,
};

export const DEFAULT_CONSUMABLES: ConsumablesSettings = {
  caulk_type: 'osi-quad',
  include_paintable_caulk: true,
  include_color_matched_caulk: true,
  include_titebond_caulk: false,
  include_primer_cans: false,
  include_spackle: false,
  include_wood_blades: false,
  include_hardie_blades: true,
  include_siding_nails: true,
  include_trim_nails: true,
};

export const DEFAULT_OVERHEAD: OverheadSettings = {
  include_dumpster: true,
  dumpster_cost: 1340,
  include_toilet: true,
  toilet_cost: 400,
  mobilization: 500,
  mobilization_note: 'Field Walks/Fuel',
  li_rate: 4.68,
  insurance_rate: 16.5,
  crew_size: 4,
  estimated_weeks: 2,
...
export const DEFAULT_ESTIMATE_CONFIG: EstimateConfig = {
  ...
  window_trim: DEFAULT_WINDOW_TRIM,
  door_trim: DEFAULT_DOOR_TRIM,
  top_out: DEFAULT_TOP_OUT,
  belly_band: DEFAULT_BELLY_BAND,
  corners: DEFAULT_CORNERS,
  wrb: DEFAULT_WRB,
  flashing: DEFAULT_FLASHING,
  consumables: DEFAULT_CONSUMABLES,
  overhead: DEFAULT_OVERHEAD,
};

export const DEFAULT_ESTIMATE_DEFAULTS_V1: EstimateDefaultsV1 = {
  markup_percent: 15,
...
export const TRIM_SYSTEM_CASCADES: Record<TrimSystem, {
  ...
  whitewood: {
    ...
    flashing: {
      ...
      include_fortiflash: true,
      include_moistop: true,
      include_rolled_galv: true,
    },
    consumables: {
      caulk_type: 'titebond',
      include_paintable_caulk: false,
      include_color_matched_caulk: false,
      include_titebond_caulk: true,
      include_primer_cans: true,
      include_spackle: true,
      include_wood_blades: true,
      include_hardie_blades: true,
    },
  },
};
