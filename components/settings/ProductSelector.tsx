      ...
      <div className="relative">
        ...
        <button
          ...
          className={cn(
            ...
            'border border-border rounded-md bg-white text-sm',
              ...
              <div className="max-h-56 overflow-y-auto">
                {filteredProducts.length === 0 ? (
                  ...
                  Object.entries(groupedProducts).map(([cat, items]) => (
                    <div key={cat}>
                      <div className="px-3 py-1.5 text-xs font-semibold text-muted-foreground bg-muted uppercase tracking-wide">
...
function ProductOption({ product, isSelected, onSelect }: ProductOptionProps) {
  return (
    ...
    >
      ...
      <div className="text-sm font-medium text-brand-foreground flex-shrink-0">
